 ...
 *
 * Modificado por Lostium Project
 *
 * Incorporamos la información exif al listener onProcessed
 *
 */
(function ($) {
    ...
    $.fn.html5Uploader = function (options) {
        ...
        function startProcess(fileOrUrl) {
            var callback = function () {
                ...
                //******************************************************************
                //
                // Modificamos el comportamiento para almacenar el BLOB en el componente
                // y no hacemos upload automático
                //
                //******************************************************************
                settings.blob = blob;
            };
        ...
        function scaleAndCropImage(img) {
            ...
            settings.onProcessed && settings.onProcessed(canvas,$(img).data('exif'));
